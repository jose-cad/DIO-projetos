...
async def query(
	...
	lista_resumo = [
		AtletaResumo(
			nome=atleta.nome,
			categoria=CategoriaOut.model_validate(atleta.categoria),
			centro_treinamento=CentroTreinamentoOut.model_validate(atleta.centro_treinamento),
		)
		for atleta in atletas
	]

	return paginate(lista_resumo)
